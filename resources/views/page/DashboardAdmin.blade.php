    ...
    <div id="popup-form" class="hidden fixed top-0 left-0 w-full h-full bg-gray-500 bg-opacity-50">
        <div class="bg-white p-4 w-1/2 mx-auto mt-20 rounded-lg">
            ...
            <form class="mb-5">
                ...
                <input type="text" id="product-name" class="block w-full p-2 pl-10 text-sm rounded-lg text-gray-700"
                    required>
                ...
                <input type="number" id="auction-duration"
                    class="block w-full p-2 pl-10 text-sm rounded-lg mt-6 text-gray-700" required>

                <button class="bg-black hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-5"
                    type="submit">Add Product</button>
            </form>
            <!-- form close-->

            <button id="close-btn"
                class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded absolute top-0 right-0 mt-4 mr-4">Close</button>
        </div>
    </div>
